...
We tried to find and use other jailbreak prompts that could potentially work, but none of them did.
...
\begin{figure}[htp]
\begin{centering}
\includegraphics[width=10cm]{BP/assets/images/perplexity-climate.png}
\par\end{centering}
