...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width=10cm]{BP/assets/images/deepseek-ransomware1.png}
\par\end{centering}
\caption{First prompt for ransomware after setup prompt \cite{} %insert link to prompt in cite ?
