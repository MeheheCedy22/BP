...
Jailbreak is a state in which the model is currently in that does not respect its content moderation. The model in this state can be misused to generate harmful content, which was discussed eariler in section~\ref{sec:risks}.

We refer to jailbreak or jailbreaking as
